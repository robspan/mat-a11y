 ...
 *
 * Usage:
 *   node dev-tools/benchmark.js [path] [runs]
 *
 * Examples:
 *   node dev-tools/benchmark.js                     # Test on src folder, 10 runs
 *   node dev-tools/benchmark.js ./my-project/src    # Test on custom path
 *   node dev-tools/benchmark.js ./src 5             # 5 runs per config
 */
